...
* /notebooks - contains interactive Jupyter notebooks detailing the main the data transformations
   ...
   * [```H-clustering.ipynb```](https://github.com/nestorsaiz/saiz-et-al_2020/blob/master/notebooks/H-clustering.ipynb) demonstrates the steps taken to classify ICM cells using Hierarchical Clustering in two published datasets ([Saiz _et al._ (2016)](https://doi.org/10.1038/ncomms13463) and [Morgani _et al._, (2018) *Dev Bio*](https://doi.org/10.1016/j.ydbio.2018.06.017)) and compares the outcome to the original classification using K-means Clustering
